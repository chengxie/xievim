...
if !exists("g:DoxygenToolkit_projectName")
  let g:DoxygenToolkit_projectName = ""
endif

if !exists("g:DoxygenToolkit_projectWebsite")
  let g:DoxygenToolkit_projectWebsite = ""
endif
if !exists("g:DoxygenToolkit_authorEmail")
  let g:DoxygenToolkit_authorEmail = ""
endif
if !exists("g:DoxygenToolkit_copyright")
  let g:DoxygenToolkit_copyright = ""
endif
if !exists("g:DoxygenToolkit_svnkeywordTag")
  let g:DoxygenToolkit_svnkeywordTag = "$Id$"
endif
...
function! <SID>DoxygenAuthorFuncEx()
  call s:InitializeParameters()
  ...
  exec "normal ".l:insertionMode."\t".g:DoxygenToolkit_projectName
  if (g:DoxygenToolkit_projectWebsite != "")
  	exec "normal o"."\<BS>\t".g:DoxygenToolkit_projectWebsite
  endif
  exec "normal o"
  exec "normal o"."\<BS>\tFile: \t\t".l:fileName
  exec "normal o"."\<BS>\tAuthor: \t".g:DoxygenToolkit_authorName
  if (g:DoxygenToolkit_authorEmail != "")
  	exec "normal o"."\<BS>\tEmail: \t\t".g:DoxygenToolkit_authorEmail
  endif
  exec "normal o"."\<BS>\tBrief: \t\t"
  mark d
  " 增加svn的keyword
  exec "normal o"
  exec "normal o"."\<BS>\t".g:DoxygenToolkit_svnkeywordTag
  exec "normal o"
  exec "normal o"."\<BS>\t".g:DoxygenToolkit_copyright

  if ( g:DoxygenToolkit_endCommentTag != "" )
    exec "normal o"."\<BS>".s:endCommentTag
  endif
...
function! <SID>DoxygenAuthorFunc()
  ...
  exec "normal o".s:interCommentTag.g:DoxygenToolkit_svnkeywordTag
...
command! -nargs=0 DoxAuthorEx :call <SID>DoxygenAuthorFuncEx()
