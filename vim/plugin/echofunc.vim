...
"用以用键盘来显示函数原型
nmap <silent><C-X><C-M> :call DeFunc()<CR>
imap <silent><C-X><C-M> <ESC><C-X><C-M>a
nmap <silent><C-X><C-B> :call EchoFuncClear()<CR>
imap <silent><C-X><C-B> <ESC><C-X><C-B>a
nmap <silent><C-X><C-P> :call EchoFuncP()<CR>
nmap <silent><C-X><C-N> :call EchoFuncN()<CR>
imap <silent><C-X><C-P> <ESC><C-X><C-P>a
imap <silent><C-X><C-N> <ESC><C-X><C-N>a
