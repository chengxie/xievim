...
try
	...
	sign define bookmark text=>> linehl=bookmark_color texthl=bookmark_color
endtry

" Key Mappings
if !hasmapto(':ToggleBookmark')
	nmap <silent> <F5> :ToggleBookmark<CR>
	imap <silent> <F5> <ESC><F5>a
endif

if !hasmapto(':NextBookmark')
	nmap <silent> <F6> :NextBookmark<CR>
	imap <silent> <F6> <ESC><F6>a
endif

if !hasmapto(':PreviousBookmark')
	nmap <silent> <F7> :PreviousBookmark<CR>
